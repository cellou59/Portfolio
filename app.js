...
.pauseFor(1800)
.changeDelay(20)
.typeString('Hello! Je suis Cellou Diallo')
.pauseFor(600)
.typeString(' ,<strong> Développeur junior !</strong>')
.pauseFor(600)
.deleteChars(9)
.typeString('<span style="color: #27ae60;"><strong> CSS !</strong></span>')
.pauseFor(600)
.deleteChars(5)
.typeString('<span style="color: #FFC300;"><strong> JavaScript !</strong></span>')
.pauseFor(600)
.deleteChars(12)
.typeString('<span style="color: #61dbfb;"><strong> React !</strong></span>')
.pauseFor(600)
.deleteChars(7)
.typeString('<span style="color: #ff6910;"><strong> Front-End !</strong></span>')
.start()
...
const titrePortefolio = document.querySelector('.titre-port')
const itemPortefolio = document.querySelectorAll('.vague1')

const tlPortfolio = new TimelineMax();

tlPortfolio
.from(titrePortefolio, {y:-50, opacity: 0, duration: 0.5})
.staggerFrom(itemPortefolio,1, {opacity: 0},0.2,'-=0.5')
...
const itemPortefolio2 = document.querySelectorAll('.vague2')

const tlPortfolio2 = new TimelineMax();

tlPortfolio2
.staggerFrom(itemPortefolio2,1, {opacity: 0},0.2,'-=0.5')

const scene3 = new ScrollMagic.Scene({
    triggerElement: itemPortefolio,
    triggerhook: 0.2,
    reverse:false
})
...
const itemPortefolio3 = document.querySelectorAll('.vague3')

const tlPortfolio3 = new TimelineMax();

tlPortfolio3
.staggerFrom(itemPortefolio3,1, {opacity: 0},0.2,'-=0.5')

const scene4 = new ScrollMagic.Scene({
    triggerElement: itemPortefolio2,
    triggerhook: 0.2,
    reverse:false
})
...
const allProjets = document.querySelectorAll('.projet-skill');
const allShadowBarres =document.querySelectorAll('.barre-grises');
const explicationBarre =document.querySelector('.explication-barre');
...
.staggerFrom(allProjets, 0.5, {y:-10, opacity:0}, 0.1, '-=1')
.from(explicationBarre, {opacity: 0,duration: 0.6} )
